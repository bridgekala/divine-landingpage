...
<body class="p-0 m-0">
    <div class="row formlayout">
        ...
        <div class="col-lg-6 bg-white p-5">
            <div class="p-lg-5 d-flex align-items-center justify-content-center">
                <form class="d-flex flex-column gap-4 w-80" autocomplete="off" method="post" name="yashika" action="sheets.php">
                    <div>
                        Name
                        <sup>
                            <i class="fa fa-asterisk" aria-hidden="true" style="color: red;font-size:7px;"></i>
                        </sup>
                        <br>
                    ...
                    <div>
                        Your Message
                        <br>
                        <textarea name="message" id="message" rows="3" placeholder="Message (Optional)" value=""></textarea>
                    </div>
                    <div>
                        <button type="submit" name="submit" id="submit"
                            class="text-white w-100 rounded-2 border-0 bg-black p-3">Submit</button>
                    </div>
                </form>
            </div>
        </div>
